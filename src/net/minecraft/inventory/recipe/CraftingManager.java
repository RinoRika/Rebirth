...
public class CraftingManager {
    ...
    public static CraftingManager getInstance() {
        LogManager.getLogger().info("[CraftingManager] Loading crafting recipes...");
    ...
    private CraftingManager() {
        ...
        LogManager.getLogger().info("[CraftingManager] Loaded {} recipes.", this.recipes.size());
    }
    ...
    public ItemStack findMatchingRecipe(final int[] arr) {
        for (IRecipe iRecipe : this.recipes) {
            if (iRecipe.matchRecipe(arr)) {
                return iRecipe.createResult(arr);
            }
        }
        return null;
    }
