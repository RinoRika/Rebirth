...
public class ChunkProviderGenerate implements IChunkProvider {
    ...
    public void generateTerrain(final int integer1, final int integer2, final byte[] arr) {
        ...
        this.field_4180_q = this.func_4061_a(this.field_4180_q, integer1 * n, 0, integer2 * n, integer3, integer4, integer5);
        for (int i = 0; i < n; ++i) {
            for (int j = 0; j < n; ++j) {
                for (int k = 0; k < 16; ++k) {
                    ...
                    final double n8 = (this.field_4180_q[((i + 0) * integer5 + (j + 0)) * integer4 + (k + 1)] - n4) * n3;
                    final double n9 = (this.field_4180_q[((i + 0) * integer5 + (j + 1)) * integer4 + (k + 1)] - n5) * n3;
                    final double n10 = (this.field_4180_q[((i + 1) * integer5 + (j + 0)) * integer4 + (k + 1)] - n6) * n3;
                    final double n11 = (this.field_4180_q[((i + 1) * integer5 + (j + 1)) * integer4 + (k + 1)] - n7) * n3;
                    for (int l = 0; l < 8; ++l) {
    ...
    protected void a(final int integer1, final int integer2, final byte[] arr, final double double4, final double double5, final double double6) {
        this.a(integer1, integer2, arr, double4, double5, double6, 1.0f + this.rand.nextFloat() * 6.0f, 0.0f, 0.0f, -1, -1, 0.5);
    }

    protected void a(final int integer1, final int integer2, final byte[] arr, double double4, double double5, double double6, final float float7, float float8, float float9, int integer10, int integer11, final double double12) {
        ...
        while (integer10 < integer11) {
            ...
            if (!b && integer10 == n6 && float7 > 1.0f) {
                this.a(integer1, integer2, arr, double4, double5, double6, random.nextFloat() * 0.5f + 0.5f, float8 - 1.5707964f, float9 / 3.0f, integer10, integer11, 1.0);
                this.a(integer1, integer2, arr, double4, double5, double6, random.nextFloat() * 0.5f + 0.5f, float8 + 1.5707964f, float9 / 3.0f, integer10, integer11, 1.0);
                return;
            }
        ...
        for (int i = integer1 - n; i <= integer1 + n; ++i) {
            for (int j = integer2 - n; j <= integer2 + n; ++j) {
                ...
                for (int k = 0; k < nextInt; ++k) {
                    ...
                    for (int l = 0; l < n7; ++l) {
                        this.a(integer1, integer2, arr, n4, n5, n6, this.rand.nextFloat() * 2.0f + this.rand.nextFloat(), this.rand.nextFloat() * 3.1415927f * 2.0f, (this.rand.nextFloat() - 0.5f) * 2.0f / 8.0f, 0, 0, 1.0);
                    }
                }
            }
        }
    ...
    private double[] func_4061_a(double[] arr, final int integer2, final int integer3, final int integer4, final int integer5, final int integer6, final int integer7) {
        if (arr == null) {
            arr = new double[integer5 * integer6 * integer7];
        }
        final double n = 684.412;
        final double n2 = 684.412;
        this.field_4182_g = this.field_922_a.a(this.field_4182_g, integer2, integer3, integer4, integer5, 1, integer7, 1.0, 0.0, 1.0);
        this.field_4181_h = this.field_921_b.a(this.field_4181_h, integer2, integer3, integer4, integer5, 1, integer7, 100.0, 0.0, 100.0);
        this.field_4185_d = this.field_910_m.a(this.field_4185_d, integer2, integer3, integer4, integer5, integer6, integer7, n / 80.0, n2 / 160.0, n / 80.0);
        this.field_4184_e = this.field_912_k.a(this.field_4184_e, integer2, integer3, integer4, integer5, integer6, integer7, n, n2, n);
        this.field_4183_f = this.field_911_l.a(this.field_4183_f, integer2, integer3, integer4, integer5, integer6, integer7, n, n2, n);
        int n3 = 0;
        int n4 = 0;
