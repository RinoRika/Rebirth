...
public class ChunkProviderLoadOrGenerate implements IChunkProvider {
    ...
    public Chunk provideChunk(final int integer1, final int integer2) {
        ...
        if (!this.chunkExists(integer1, integer2)) {
            ...
            Chunk chunk = this.getChunk(integer1, integer2);
            if (chunk == null) {
    ...
    private Chunk getChunk(final int integer1, final int integer2) {
    ...
    public boolean saveChunks(final boolean boolean1, final IProgressUpdate jd) {
        ...
        if (jd != null) {
            for (Chunk chunk : this.chunks) {
                if (chunk != null && chunk.needsSaving(boolean1)) {
                    ++n2;
                }
            }
        }
        ...
        for (Chunk chunk : this.chunks) {
            if (chunk != null) {
                if (boolean1 && !chunk.neverSave) {
                    this.saveExtraChunkData(chunk);
                }
                if (chunk.needsSaving(boolean1)) {
