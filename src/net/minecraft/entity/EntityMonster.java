...
public class EntityMonster extends EntityCreature {
    ...
    public boolean getCanSpawnHere(final double nya1, final double nya2, final double nya3) {
        return this.worldObj.getBlockLightValue(MathHelper.floor_double(nya1), MathHelper.floor_double(nya2), MathHelper.floor_double(nya3)) <= this.rand.nextInt(8) && super.getCanSpawnHere(nya1, nya2, nya3);
    }
}
