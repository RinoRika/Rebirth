...
import static net.minecraft.client.renderer.GlStateManager.createDirectIntBuffer;
...
public class VboRegion
{
    ...
    {
        this.bufferIndexVertex = createDirectIntBuffer(this.capacity);
        this.bufferCountVertex = createDirectIntBuffer(this.capacity);
        this.drawMode = 7;
    ...
    private void copyVboData(int posFrom, int posTo, int size)
    {
        ...
        Minecraft.getMinecraft().checkGLError("Copy VBO range");
    ...
    private void expandVbo(int sizeMin)
    {
        ...
        Minecraft.getMinecraft().checkGLError("Expand VBO");
        ...
        Minecraft.getMinecraft().checkGLError("Copy VBO: " + k);
        OpenGlHelper.glBindBuffer(OpenGlHelper.GL_COPY_READ_BUFFER, 0);
        OpenGlHelper.glBindBuffer(OpenGlHelper.GL_COPY_WRITE_BUFFER, 0);
        OpenGlHelper.glDeleteBuffers(this.glBufferId);
        this.bufferIndexVertex = createDirectIntBuffer(i);
        this.bufferCountVertex = createDirectIntBuffer(i);
        this.glBufferId = l;
        this.capacity = i;
    }
