...
public class TextureUtil
{
 ...
 //   public static final int[] missingTextureData = missingTexture.getTextureData();
    ...
    public static void setTextureBlurMipmap(boolean p_147954_0_, boolean p_147954_1_)
    {
        ...
        {
            int i = 9987; // GL_LINEAR_MIPMAP_LINEAR
    ...
    public static int[] readImageData(ResourceLocation imageLocation) throws IOException
    {
        BufferedImage bufferedimage = Minecraft.getMinecraft().renderEngine.getBufferedImageTexture(imageLocation);
