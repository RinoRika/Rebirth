...
public class ModernWorldRenderer
{
 ...
 //   public RenderEnv renderEnv = null;
    ...
    public ModernWorldRenderer(int bufferSizeIn)
    {
  ...
  //     SVertexBuilder.initVertexBuilder(this);
    ...
    public ModernWorldRenderer.State getVertexState()
    {
    ...
    public void setVertexState(ModernWorldRenderer.State state)
    {
    ...
    public ModernWorldRenderer tex(double u, double v)
    {
    ...
    public ModernWorldRenderer lightmap(int p_181671_1_, int p_181671_2_)
    {
        int i = this.vertexCount * this.vertexFormat.getNextOffset() + this.vertexFormat.getOffset(this.vertexFormatIndex);
    ...
    public ModernWorldRenderer color(float red, float green, float blue, float alpha)
    {
        return this.color((int)(red * 255.0F), (int)(green * 255.0F), (int)(blue * 255.0F), (int)(alpha * 255.0F));
    }

    public ModernWorldRenderer color(Color color)
    {
        return this.color(color.getRed(), color.getGreen(), color.getBlue(), color.getAlpha());
    }

    public ModernWorldRenderer color(int colorHex) {
        return this.color(colorHex >> 16 & 255, colorHex >> 8 & 255, colorHex & 255, colorHex >> 24 & 255);
    }

    public ModernWorldRenderer color(int red, int green, int blue, int alpha)
    {
        if (this.noColor)
        {
            return this;
    ...
    public ModernWorldRenderer pos(Vec3D vec) {
        return this.pos(vec.xCoord, vec.yCoord, vec.zCoord);
    }

    public ModernWorldRenderer pos(double x, double y) {
        return this.pos(x, y, 0.0);
    }

    public ModernWorldRenderer pos(double x, double y, double z)
    {
        int i = this.vertexCount * this.vertexFormat.getNextOffset() + this.vertexFormat.getOffset(this.vertexFormatIndex);
    ...
    public ModernWorldRenderer normal(float p_181663_1_, float p_181663_2_, float p_181663_3_)
    {
        int i = this.vertexCount * this.vertexFormat.getNextOffset() + this.vertexFormat.getOffset(this.vertexFormatIndex);
