...
import net.minecraft.MinecraftError;
...
public class LoadingScreenRenderer implements IProgressUpdate {
    ...
    public LoadingScreenRenderer(final Minecraft aw) {
        this.field_1004_a = "";
    ...
    public void setLoadingProgress(final int integer) {
        if (!this.mc.running) {
            ...
            GlStateManager.bindTexture(this.mc.renderEngine.getTexture("/dirt.png"));
            final float n = 32.0f;
