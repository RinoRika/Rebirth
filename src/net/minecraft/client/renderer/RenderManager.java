...
import net.minecraft.client.entity.model.ModelPig;
import net.minecraft.client.entity.model.ModelSheep1;
import net.minecraft.client.entity.model.ModelSheep2;
import net.minecraft.client.entity.model.ModelSkeleton;
import net.minecraft.client.entity.model.ModelZombie;
...
public class RenderManager {
    ...
    public Render getEntityClassRenderObject(Class clazz) {
        Render bq2 = this.entityRenderMap.get(clazz);
