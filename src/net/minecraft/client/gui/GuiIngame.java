...
public class GuiIngame extends Gui {
    ...
    public GuiIngame(final Minecraft aw) {
    ...
    public void renderGameOverlay(final float float1, final boolean boolean2, final int integer3, final int integer4) {
        ...
        GlStateManager.bindTexture(this.mc.renderEngine.getTexture("/gui/gui.png"));
        ...
        GlStateManager.bindTexture(this.mc.renderEngine.getTexture("/gui/icons.png"));
        GL11.glEnable(3042);
        ...
        if (this.mc.gameSettings.showDebugInfo) {
            // Debug Info Left
            fontRenderer.drawStringWithShadow2("Rebirth [Minecraft Infdev-20100618] (" + this.mc.debug + ")", 2, 2, 16777215);
            ...
            fontRenderer.drawStringWithShadow2("X: " + mc.thePlayer.posX, 2, 52, 16777215);
            fontRenderer.drawStringWithShadow2("Y: " + mc.thePlayer.posY, 2, 62, 16777215);
            fontRenderer.drawStringWithShadow2("Z: " + mc.thePlayer.posZ, 2, 72, 16777215);

            fontRenderer.drawStringWithShadow2("Time: " + mc.theWorld.getWorldTime(), 2, 92, 16777215);
            fontRenderer.drawStringWithShadow2("Block Under: " + mc.theWorld.getBlockId(MathHelper.floor_double(mc.thePlayer.posX), MathHelper.floor_double(mc.thePlayer.posY) - 2, MathHelper.floor_double(mc.thePlayer.posZ)), 2, 102, 16777215);

            // Debug Info Right
            final long maxMemory = Runtime.getRuntime().maxMemory();
            final long totalMemory = Runtime.getRuntime().totalMemory();
            final long n2 = totalMemory - Runtime.getRuntime().freeMemory();
            final String string = "Used memory: " + n2 * 100L / maxMemory + "% (" + n2 / 1024L / 1024L + "MB) of " + maxMemory / 1024L / 1024L + "MB";
            ...
            fontRenderer.drawStringWithShadow2("Rebirth [Minecraft Infdev-20100618]", 2, 2, 16777215);
        }
        int i = 10;
    ...
    private void renderVignette(float float1, final int integer2, final int integer3) {
        ...
        GlStateManager.bindTexture(this.mc.renderEngine.getTexture("/misc/vignette.png"));
