...
public class TextureGearsFX extends TextureFX {
    ...
    public TextureGearsFX(final int integer) {
        ...
        this.gearsInt1 = 2;
        try {
            ImageIO.read(TextureGearsFX.class.getResource("/misc/gear.png")).getRGB(0, 0, 32, 32, this.gearsIntArray1, 0, 32);
            ImageIO.read(TextureGearsFX.class.getResource("/misc/gearmiddle.png")).getRGB(0, 0, 16, 16, this.gearsIntArray2, 0, 16);
