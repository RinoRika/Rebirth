...
package net.minecraft.client.canvas;
...
import net.minecraft.IsoImageBuffer;
import net.minecraft.TerrainTextureManager;
import net.minecraft.ThreadRunIsoClient;
import net.minecraft.util.EnumOS1;
import net.minecraft.util.OsMap;
import net.minecraft.world.World;
import net.minecraft.world.chunk.storage.SaveHandler;
